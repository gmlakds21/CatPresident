...
<div id="mypgmn" class="row col-9 MY_pad0mgn0">
    <div class="col-2 MY_mainsidebr">
        ...
        <ul class="MY_pad0mgn0">
            ...
            <li class="MY_li">
                <a class="MY_here" href="/mypage/stickers">
                    <span>스티커</span>
                    <span class="bi bi-chevron-right MY_chevron"></span>
                </a>
            </li>
    ...
    <div class="col-10 MY_maincont">
        <h3 class="row MY_conttitle">스티커</h3>
        <ul class="nav nav-tabs" id="MY_sticstat" role="tablist">

            <li class="nav-item" role="presentation" style="margin: 0">
                <a class="nav-link active" id="MY_usablestic" data-toggle="tab" href="#stictb" role="tab"
                   aria-controls="stictb" aria-selected="true">보유 스티커</a>
            </li>

            <li class="nav-item" role="presentation">
                <a class="nav-link" id="MY_expdstic" data-toggle="tab" href="#expdstictb" role="tab"
                   aria-controls="expdstictb" aria-selected="false">소멸예정</a>
            </li>

        </ul>
        <div class="tab-content" id="mileagestatcont" style="min-height: 500px">
            <div class="tab-pane fade show active" id="stictb" role="tabpanel" aria-labelledby="MY_usablestic">
                <div class="MY_ordlstNON">
                    <span class="bi bi-emoji-frown" style="font-size: 50px"></span>
                    <strong style="display: block;">사용 가능한 스티커가 없습니다.</strong>
                </div>
            </div>
            <div class="tab-pane fade" id="expdstictb" role="tabpanel" aria-labelledby="MY_expdstic">
                <div class="MY_ordlstNON">
                    <span class="bi bi-emoji-frown" style="font-size: 50px"></span>
                    <strong style="display: block;">사용 만료된 스티커가 없습니다.</strong>
                </div>
            </div>
        </div>
